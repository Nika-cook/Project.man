...
function viewTransactions() {
  ...
  if (!credentials) {
    // РџСЂРѕРІРµСЂСЏРµРј, РµСЃС‚СЊ Р»Рё РґР°РЅРЅС‹Рµ РІ credentials
...
function togglePassword(inputId, imgElement) {
  ...
  if (input.type === 'password') {
    input.type = 'text'
    imgElement.src = 'img/closed-eye.png' // РРєРѕРЅРєР° РѕС‚РєСЂС‹С‚РѕРіРѕ РіР»Р°Р·Р°
  } else {
    input.type = 'password'
    imgElement.src = 'img/eye.png' // РРєРѕРЅРєР° Р·Р°РєСЂС‹С‚РѕРіРѕ РіР»Р°Р·Р°
  }
}
